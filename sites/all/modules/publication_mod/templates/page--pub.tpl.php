  ...
  <div id="inner_header_wrapper">
    ...
    <header id="header" role="banner">
      ...
      <div class="top_left">
        ...
        <?php 
		$mynewurl='http://web-cms-test-d7.ics.forth.gr/';
		if ($logo): ?>
          <div id="logo">
            <a href="<?php print $mynewurl; ?>" title="<?php print t('Homepage'); ?>">
        ...
        <h1 id="site-title">
          <a href="<?php print $front_page; ?>" title="<?php print t('Homepage'); ?>"><?php print $site_name; ?></a>
...
<div id="footer">
  ...
  <?php if ($page['footer_first'] || $page['footer_second'] || $page['footer_third'] || $page['footer_forth']): ?> 
    <div id="footer_wrapper">    
      <div id="footer-area" class="clearfix">
        ...
        <div class="column box1"><?php print render($page['footer_first']); ?></div>
        <?php endif; ?>
        <?php if ($page['footer_second']): ?>
        <div class="column box2"><?php print render($page['footer_second']); ?></div>
        <?php endif; ?>
        <?php if ($page['footer_third']): ?>
        <div class="column box3"><?php print render($page['footer_third']); ?></div>
        <?php endif; ?>
        <?php if ($page['footer_forth']): ?>
        <div class="column box4"><?php print render($page['footer_forth']); ?></div>
        <?php endif; ?>
      </div>    
    </div>
  <?php endif; ?>
 ...
 <div class="footer_empty_inner"> 
  ...
  <div id="mine_footer">
  <div class="inner">
   <!-- <div class="bottomsideL"><p>Designed and Developed by <a href="mailto:">ICS Creative team</a></p></div>-->
<div class="bottomsideR">
  <p> <a href="/conditions-use">   CONDITIONS OF USE</a> <a id ="leftLine" href="/privacy-policy">   PRIVACY POLICY</a> </p>
</div>
  </div>
  </div>
